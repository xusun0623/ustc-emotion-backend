...
# 请填写您的AccessKeyId。
access_key_id = 'LTAI5tBD9kZ66LoGLPo91jmc'
# 请填写您的AccessKeySecret。
access_key_secret = 'XKCt5udrhDq483E5snW0lCBI4JHgmK'
# host的格式为 bucketname.endpoint ，请替换为您的真实信息。
host = 'http://ustc-train.oss-cn-hangzhou.aliyuncs.com';
# callback_url为 上传回调服务器的URL，请将下面的IP和Port配置为您自己的真实信息。
callback_url = "http://124.223.79.175:8000";
# 用户上传文件时指定的前缀。
upload_dir = ''
expire_time = 30
